...
export function LoadGameScreen() {
  ...
  if (selectedGuild) {
    ...
    const slots = slotIndex?.slots ?? [];

    return (
      <div className="flex flex-col items-center gap-6 p-6 min-h-dvh">
  ...
  return (
    <div className="flex flex-col items-center gap-6 p-6 min-h-dvh">
      <h1 className="text-2xl font-bold border-b-2 border-ink pb-2">Load Game</h1>
