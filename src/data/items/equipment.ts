...
export const EQUIPMENT: EquipmentDefinition[] = [
  ...
  // Quest-exclusive equipment (buyPrice: 0, not in shop)
  {
    id: 'slime-kings-crown',
    name: "Slime King's Crown",
    slot: 'accessory1',
    bonuses: { vit: 3, luc: 3, hp: 10 },
    classRestriction: null,
    description: 'A crown made from a crystallized slime core. Reward for slaying many slimes. +3 VIT, +3 LUC, +10 HP.',
    buyPrice: 0,
  },
  {
    id: 'explorers-lantern',
    name: "Explorer's Lantern",
    slot: 'accessory1',
    bonuses: { agi: 2, wis: 2, luc: 2 },
    classRestriction: null,
    description: 'A lantern that lights the deepest paths. Reward for reaching the depths. +2 AGI, +2 WIS, +2 LUC.',
    buyPrice: 0,
  },
  {
    id: 'fungal-spore-blade',
    name: 'Fungal Spore Blade',
    slot: 'weapon',
    bonuses: { str: 4, int: 3, wis: 2 },
    classRestriction: null,
    description: 'A blade that grows sharper with each swing. Reward for purging fungoids. +4 STR, +3 INT, +2 WIS.',
    buyPrice: 0,
  },
  {
    id: 'beetle-shell-aegis',
    name: 'Beetle Shell Aegis',
    slot: 'armor',
    bonuses: { vit: 5, hp: 20 },
    classRestriction: null,
    description: 'Armor forged from crystal beetle shells. Reward for cracking beetles. +5 VIT, +20 HP.',
    buyPrice: 0,
  },
  {
    id: 'core-harvester',
    ...
    bonuses: { str: 5, luc: 2 },
    classRestriction: null,
    description: 'A weapon infused with slime cores. Reward for collecting cores. +5 STR, +2 LUC.',
    buyPrice: 0,
  },
];
